                                    ...
                                    <div class="form-group mb-3" style="text-align: center">
                                        ...
                                        <select style="text-align: center"
                                            ...
                                            <c:forEach items="${romcate}" var="rs">
                                                <option value="${rs.catename}" ${rs.roomcateID==listroom.roomcateID?"selected":""}>${rs.catename}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                    <div class="row" style="text-align: center">
                                        ...
                                        <div class="form-group mb-3 col-xs-6 col-sm-4">
                                            ...
                                            <select name="Status" style="text-align: center"
                                                    ...
                                                    id="category"
                                                    >
                                                <option value="Available"${listroom.status==0?"selected":""}>Available</option>
                                                <option value="Unavailable"${listroom.status==1?"selected":""}>Unavailable</option>
                                                <option value="Other"${listroom.status==2?"selected":""}>Other</option>
                                            </select>
                                        </div>
                                    </div>
                            </div>
