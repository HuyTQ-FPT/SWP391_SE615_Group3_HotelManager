                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <form action="BlogManagerController" method="post" class="tm-edit-product-form">
                                    ...
                                    <div class="form-group mb-3">
                                     ...
                                     <div class="form-group mb-3">
                                        <label for="name" >Số người đến
                                        </label>
                                        <input id="name" name="title"type="text"class="form-control validate" required/>
                                    </div>
                                     <div class="form-group mb-3">
                                        <label for="name" >Ngày đến
                                        </label>
                                        <input id="name" name="title"type="date"class="form-control validate" required/>
                                    </div>
                                     <div class="form-group mb-3">
                                        <label for="name" >Ngày đi
                                        </label>
                                        <input id="name" name="title"type="date"class="form-control validate" required/>
                                    </div>
                                     <div class="form-group mb-3">
                                        <label for="name" >Tổng giá
                                        </label>
                                        <input id="name" name="title"type="text"class="form-control validate" required/>
                                    </div>
