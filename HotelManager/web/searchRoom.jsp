<%-- 
    Document   : searchRoom
    Created on : Jun 4, 2022, 6:01:31 PM
    Author     : admin
--%>
                                    ...
                                    <nav class="site-navigation text-right" role="navigation">
                                        <div class="container">
                                            ...
                                            <ul class="site-menu js-clone-nav d-none d-lg-block">
                                                ...
                                                <li style="font-family: PlayFair Display" class="login"><a href="Login.jsp">Login</a></li>
                                                <li style="font-family: PlayFair Display" class="register"><a href="Register.jsp">Register</a></li>
                                            </ul>
                                        </div>
                                    </nav>
                                </div>
